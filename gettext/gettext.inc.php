...
require('TextReader.php');
require('CachedFileReader.php');

use Gettext\Reader\FileReader;
use Gettext\Reader\StreamReader;
use Gettext\Reader\StringReader;
use Gettext\Reader\TextReader;
use Gettext\Reader\CachedFileReader;
...
function _get_reader($domain = null, $category = 5, $enable_cache = true)
{
    ...
    if (!isset($text_domains[$domain]->l10n)) {
        ...
        $text_domains[$domain]->l10n = new TextReader($input,
            $enable_cache);
    }
